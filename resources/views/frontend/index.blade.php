...
<div class="jumbotron">
    <div class="container color-change make-it-even">
        <div class="caption caption text-center pt-5 mb-3" data-aos="fade-up" data-aos-delay="5"
            data-aos-duration="1000">INGLÉS DE NEGOCIOS</div>
        <div class="sub-caption text-center pb-5 mb-5 mt-5" data-aos="fade-up" data-aos-delay="6"
...
<div class="container pb-3 mb-3">
    ...
    <div class="heading text-center">PROFESIONALES PROACTIVOS Y DINÁMICOS EN LA ENSEÑANZA DEL IDIOMA INGLÉS. </div>
    <div class="subheading text-center">Sólo los verdaderos profesionales, pueden formar a los líderes</div>
...
<div class="container-3 pt-3">
    ...
    <div class="column text-center mb-3 mt-3">
        <div class="aligned-evenly">
            ...
            <p class="infosec">La combinaci&oacute;n de la calidad, servicio y experiencia son nuestra
                estrat&eacute;gia
    ...
    <div class="column text-center mb-3 mt-3">
        <div class="aligned-evenly">
            ...
            <p class="infosec">Nuestros estudiantes logran las mejores puntuaciones en los exámenes TOEFL, TOEIC,
                Cambridge ESOL, IELTS, etc. Gracias a la calidad de la enseñanza y a nuestra Metodotología del más
                alto
                nivel.</p>
            <div class="aos-init" data-aos="zoom-in-down" data-aos-duration="1000"><a class="custom-link"
                    href="contacto.html">SABER MÁS</a></div>
