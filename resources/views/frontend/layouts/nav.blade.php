<nav class="navbar navbar-expand-md navbar-dark transparent-nav-custom fixed-top navbar-expand-xl" id="navbar"><a
    class="navbar-brand" href="{{ route('home')  }}"><img class="pb-2 logo-image" src="{{ asset('frontend/assets/img/logo.png') }}"
...
<div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav ml-auto">
        <li class="nav-item"><a href="{{ route('home')  }}" class="text-center nav-link active"><i
