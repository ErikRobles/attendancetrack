...
<div class="jumbotron about-us img-fluid">
    <div class="container color-change">
      <div class="caption caption text-center pt-5" data-aos="fade-up" data-aos-delay="500" data-aos-duration="1000">
        LIONSFIELD HISPANOAMERICANA</div>
      ...
      <div class="text-center">
        <button class="btn custom-button text-uppercase text-center" data-aos="fade-up" data-aos-delay="1500"
          data-aos-duration="1000"> <a class="text-white" href="{{ route('price-plan') }}">INSCRÍBETE
            HOY MISMO
          </a></button>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 col-md-6">
        <h4 class="text-uppercase">Lionsfield HISPANOAMERICANA</h4>
        ...
        <p class="quienes-body-text">
          ...
          <span class="bolded"><a href="https://lionsfield.com">Magisterial Education America </a></span>con sede en los
          Estados Unidos enfocada a la
  ...
  <div class="about-section-2">
    <div class="ab-sec-2-wrapper text-center">
      ...
      <div class="row">
        <div class="col-12 col-md-4 pb-3">
          ...
          alta calidad y rendimiento en enseñanza de lenguas extranjeras para ejecutivos y compañías en Hispanoamérica.
        </div>
        <div class="col-12 col-md-4 pb-3">
          <div class="aos-init" data-aos="flip-left" data-aos-delay="600" data-aos-duration="1000"><img
    ...
    <div class="hero">
      <div class="row">
        ...
        <div class="col-12 col-md-6">
          <p class="red-backdrop">Ya sea en clases personalizadas en línea para ejecutivos de alto nivel o en grupos
            online
            de capacitación empresarial, ofrecemos la mejor calidad educativa y un servicio de primer nivel. En la
            actualidad somos la única institución enfocada en su totalidad a la capacitación en idiomas para empresas y
            ejecutivos, y nuestro mercado nos exige resultados de excelencia.</p>
  ...
  <div class="container pb-3 mb-3 pt-5">
    ...
    <div class="subheading text-center">Inscríbete Hoy e Inicia tu Aprendizaje</div>
  ...
  <div class="container pt-3">
    <div class="text-center">
      <button class="btn custom-button-3 p-2 mb-4 text-uppercase text-center"> <a class="text-white"
          href="{{ route('price-plan') }}">VER PLANES </a></button>
    </div>
  </div>
